export const projects = [
    ...
    {
        title: "Micrositio Capacitaciones IA",
        description: "Plataforma institucional responsive para la difusión de eventos académicos. Implementación de diseño adaptativo (Mobile First) y optimización de rendimiento para alto tráfico.",
        tech: ["HTML5", "Tailwind CSS", "UX/UI", "Git Workflow"],
        githubLink: "#",
        liveLink: "https://cpce-mendoza.github.io/capacitacionIA/index.html"
    },
    {
        title: "Screenmatch API (Backend)",
    ...
    },
    {
        ...
        description: "Módulo de consumo de APIs externas. Aplicación de Principios SOLID y POO para modelar respuestas JSON complejas, transformarlas a objetos Java y persistirlas en archivos.",
        tech: ["Java", "Object Oriented Programming", "HTTP Client", "JSON Parsing"],
        githubLink: "https://github.com/diegomr949/star-wars",
        liveLink: "#"
    },
    {
        title: "Conversor de Monedas",
        description: "Utilidad de servicios financieros. Consumo de API de tasas de cambio en tiempo real (ExchangeRate-API) para realizar conversiones precisas entre múltiples divisas.",
        tech: ["Java", "API Integration", "Gson Library", "Backend Logic"],
        githubLink: "https://github.com/diegomr949/conversor-monedas",
        liveLink: "#"
    }
];